        ...
        <div class="project-list col-6" v-for="(item,index) in project" :key="item" :class="{show_project:index==project_index}" @mouseover="enlarge(index)" @mouseout="zoomOut">
            <a :href="item.url" >
                <div class="project-text">
                    ...
                    <div class="project-introduce"  @mouseenter="enlarge(index)" @mouseout="zoomOut">
                        <p >{{item.introduce}}</p>
                    </div>
                </div>
...
[    
 {
    ...
    img:"project_1.png",
        name:"巨星體能工作室",
        introduce:"這是我的第一個作品，當初的想法是能夠結合自身的專業去呈現，能夠不用花太多時間在思考做甚麼，能夠花更多得時間去設計切版以及磨練css技術，此網站主要是介紹課程、場館以及收費方式。",
    ...
    },
    {
        ...
        img:"project_2.png",
        name:"偷吃蛋糕",
        introduce:"第二次的專題我決定給自己一個大一點的挑戰，要在有限的時間內生出一個網站，並且主題還是給朋友挑選，想像在面對客戶時的感覺，這次的作品加上了許多的js及jq的應用，讓網頁互動性增強一些，這次的理念則是針對許多女性愛吃甜點又怕胖，因此寫了一個計算熱量的計算機並且推薦適當的熱量的蛋糕給使用者，讓使用者能夠偷吃蛋糕。",
    ...
    },
    {
        ...
        img:"project_3.png",
        name:"按指穴",
        introduce:"我們這組的團專是做穴道按摩，而我在團體中負責的是購物車的部分，這次使用的前端技術主要以vue以及scss為主，後端則是php及mysql，這次的挑戰非常困難，使用不熟悉的技術，第一次接API都讓我感到挑戰性十足，期許自己能夠做出媲美電商的購物車。",
